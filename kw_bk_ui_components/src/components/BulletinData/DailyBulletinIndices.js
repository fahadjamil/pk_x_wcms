...
import { BulletinIndices } from '../Table/Specific/BulletinIndices';
...
export const DailyBulletinIndices = (params) => {
        ...
        <div>
            ...
            {showResults ? (
                <Fragment>
                    ...
                    <BulletinIndices reqParams={reqParams} lang={lang}></BulletinIndices>
                </Fragment>
            ) : (
