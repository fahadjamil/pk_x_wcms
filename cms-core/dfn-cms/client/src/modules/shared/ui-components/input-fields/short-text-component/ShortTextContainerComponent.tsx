...
function ShortTextContainerComponent(props: FieldComponetModel) {
    const { dataKey, initialValue, language, componentKey, validations, fieldIndex } = props;
    const id = getComponentID('shortTextComponent', language.langKey, componentKey);
...
export default ShortTextContainerComponent;
