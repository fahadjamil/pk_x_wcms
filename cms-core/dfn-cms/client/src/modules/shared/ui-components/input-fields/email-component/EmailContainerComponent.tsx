...
function EmailContainerComponent(props: FieldComponetModel) {
    const { dataKey, initialValue, language, componentKey, validations, fieldIndex } = props;
    const id = getComponentID('emailComponent', language.langKey, componentKey);
...
export default EmailContainerComponent;
